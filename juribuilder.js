    ...
    /**
     * juribuilder.URL - Fliquid URL building/handling class
     *
     * Version: 1.0.0 BETA
     */
    juribuilder.URL = function (url) {
        this.scheme = null;
        this.host   = null;
        this.port   = null;
        this.path   = null;
    ...
    /**
     * thisURL() parses the current window.location and returns a juribuilder.URL object
     */
    juribuilder.URL.thisURL = function () {
        return new juribuilder.URL(window.location.href);
    }

    juribuilder.URL.prototype = new Object();

    /**
     * set() parses a url and sets the properties of the juribuilder.URL object
     */
    juribuilder.URL.prototype.set = function (url) {
        var p;
    ...
    /**
     * removeArg() is used remove a specified argument from the juribuilder.URL object arguments
     */
    juribuilder.URL.prototype.removeArg = function (k) {
    ...
    /**
     * addArg() is used to add an argument with specified value to the juribuilder.URL object arguments
     */
    juribuilder.URL.prototype.addArg = function (k, v, o) {
        if (k && String(k.constructor) == String(Array)) { // TODO: Change to use is_array
            var t = this.args;
            for (var i=0; i < k.length-1; i++) {
     ...
     */
    juribuilder.URL.prototype.parseURL = function (url) {
     ...
     */
    juribuilder.URL.prototype.parseArgs = function (s) {
        var a = {};
        if (s && s.length) {
            var kp, kv;
            var p;
     ...
     */
    juribuilder.URL.prototype.toArgs = function (a, p) {
    ...
    /**
     * toAbsolute() returns a string containing the absolute URL for the current juribuilder.URL object
     */
    juribuilder.URL.prototype.toAbsolute = function () {
        var s = '';
    ...
    /**
     * toRelative() returns a string containing the relative URL for the current juribuilder.URL object
     */
    juribuilder.URL.prototype.toRelative = function () {
        var s = '';
    ...
    /**
     * isHost() is used to determine whether the host in the juribuilder.URL object matches the current host
     */
    juribuilder.URL.prototype.isHost = function () {
        var u = juribuilder.URL.thisURL();
        return (this.host == null || this.host == u.host ? true : false);
    }

    /**
     * toString() returns a string containing the current juribuilder.URL object as a URL
     */
    juribuilder.URL.prototype.toString = function () {
